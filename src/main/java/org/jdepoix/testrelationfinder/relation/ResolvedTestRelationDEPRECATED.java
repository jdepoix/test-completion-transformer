...
public class ResolvedTestRelationDEPRECATED {
    ...
    private final ResolvedTestRelationDEPRECATED.ResolutionStatus resolutionStatus;
    ...
    public ResolvedTestRelationDEPRECATED(
        String repoName,
        TestRelation.Type relationType,
        ResolvedTestRelationDEPRECATED.ResolutionStatus resolutionStatus,
